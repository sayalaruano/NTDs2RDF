...
with st.container():
        st.write("### What drugs are used to treat Leishmaniasis?")
        ...
        st.markdown("---")
with st.container():
        st.write("### What drugs are used to treat Chagas disease and African Trypanosomiasis?")
        ...
        st.markdown("---")
with st.container():
        st.write("### What drugs are used to treat at least two out of the three NTDs?")
        ...
        st.markdown("---")
with st.container():
        st.write("### What drug against Chagas disease has the highest number of gene targets?")
        ...
        st.markdown("---")
with st.container():
        st.write("### What are the genes associated to African Trypanosomiasis?")
...
with st.container():
        st.write("### What genes are associated to Leishmaniasis and Chagas Disease?")
...
with st.container():
        ...
        st.markdown("---")
with st.container():
        st.write("### What are the top 30 pathways associated to the highest number of genes involved in Leishmaniasis?")
        ...
        st.markdown("---")
with st.container():
        st.write("### What are the top 20 pathways associated to the highest number of genes involved in the three NTDs?")
